...
public class CreateVideoSegments extends AsyncTask<String, Double, Integer> {
    ...
    public int split(String path, String destinationPath, double splitDuration) {
        ...
        Log.i("DASH", "Total time taken to create " + (segmentNumber - 1) +
                " segments: " + (start2 - start1) + "ms");

        return segmentNumber - 1;
    }


    private boolean performSplit(double startTime, double endTime, int segmentNumber) throws IOException {
